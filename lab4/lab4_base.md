...
Использование имён в целом и использование хорошо описывающих имён крайне упрощает чтения как кода, так как ты можешь понять, что за непонятные строчки кода запускаются строчкой ниже, а также позволяет сделать более красивый и понятный вывод в разделе Action, сравним два варианта:
